...
namespace CodeGen
{
    public partial class frmAdvancedGenerating : Form
    {
        ...
        {
            if(!clsDatabase.IsDatabaseExist(_SelectedDatabase))
            {
                MessageBox.Show("The selected database Is not exist. Please choose a valid database.",
                       "Database Error",
            ...
            foreach(List<clsColumn> Table in _DatabaseTables)
            {
                ...
                {
                    if(clsUtil.IsFileExist(_SelectedPath, DALGenerator.TableClassName + FileExtension))
                    {
        ...
        private void btnGenerateBL_Click(object sender, EventArgs e)
        {
            ...
            foreach(List<clsColumn> Table in _DatabaseTables)
            {
                ...
                {
                    if(clsUtil.IsFileExist(_SelectedPath, BLGenerator.TableClassName + FileExtension))
                    {
